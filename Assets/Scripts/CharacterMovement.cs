...
{
    public GameObject camera, fakeLand, fakeBody, healthBar, skateBoard, gameOver, score, distance, plus1000;
    float camDistanceY, camDistanceZ, fwdSpeed = 0.5f, sideSpeed = 0.25f, animationTime = 1f, gravityScale = 15, tiltScale = 10f, tiltDuration = .2f;
    int timeInSpace = 0, floatingLimit = 5, overFloatingPunishment = 7, pumbingCost = 3;
    public int gravityDirection = 1, currentHealth = 100;
